...
BLECharCharacteristic buttonCharacteristic("19B10012-E8F2-537E-4F6C-D104768A1214",  BLENotify); // allows remote device to get notifications
...
void loop() {
  ...
  if (Serial.available() > 0) {
    ...
    //  getCharacteristic.setValue(incomingByte);
      buttonCharacteristic.setValue(incomingByte);
   }
